  ...
  try {
    ...
    if (company) {
      return {
        ...
        data: {
          ...
          invoiceFooterText: company.invoiceFooterText || "Goods once sold cannot be returned without original cash memo & DGDA compliance verification.",
    ...
    return {
      ...
      data: {
        ...
        tradeLicenseNo: "TR-DHK-2026-8891",
        drugLicenseNo: "DGDA-DL-9842-W",
        taxIdTin: "TIN-89342019-2026",
        email: "accounts@apexpharma.com.bd",
        phone: "+880 1711-223344",
        address: "Plot 14, Tejgaon Commercial Area",
        city: "Dhaka",
        country: "Bangladesh",
        currency: "BDT",
